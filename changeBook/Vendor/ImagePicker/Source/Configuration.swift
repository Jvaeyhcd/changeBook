...
public struct Configuration {
  ...
  public var numberLabelFont = UIFont.boldSystemFont(ofSize: 19)
  public var doneButton = UIFont.systemFont(ofSize: 19)
  public var flashButton = UIFont.systemFont(ofSize: 12)
  public var noImagesFont = UIFont.systemFont(ofSize: 18)
  public var noCameraFont = UIFont.systemFont(ofSize: 18)
  public var settingsFont = UIFont.systemFont(ofSize: 16)
