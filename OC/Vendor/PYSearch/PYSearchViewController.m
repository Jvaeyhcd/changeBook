...
- (void)setup
{
    ...
    [btn setTitle: [NSBundle py_localizedStringForKey:PYSearchCancelButtonText] forState: UIControlStateNormal];
    ...
    searchBar.backgroundImage = [NSBundle py_imageNamed:@"bgImage"];
